...
INSERT INTO `book_lesson` VALUES (1,1,'First lesson','L\'eau est sale papi',1,NULL),(2,1,'Leçon 2','Travailleur heiiin ?',2,NULL),(3,2,'Leçon 3','C ki la meuf là',1,NULL),(4,2,'Leçon 4','Moi j\'aime bien le café',2,NULL),(5,2,'Leçon 5','Le médicament sera sucré. C\'est ouf',3,NULL),(6,2,'Leçon 6','Malade be le zazakely',4,NULL),(7,2,'Leçon 7','Le zébu est anorexique',5,NULL),(18,2,'Slt c cora','Lafo be les radis aussi làààà',6,NULL),(19,2,'Miriam la pétasse','Cora',7,NULL);
...
INSERT INTO `complaint` VALUES (38,523,'non, il n\'est pas travailleur','in progress'),(40,57,'tsara ny rano sy trano madio','in progress');
...
INSERT INTO `course` VALUES (1,'Apprendre le malgache','avec Prosper',1),(2,'Cora','et ses cheveux',2);
...
CREATE TABLE `fos_user` (
  ...
  `daily_objective` int(11) DEFAULT NULL,
  `learning_session_count_that_day` int(11) DEFAULT NULL,
  `current_serie` int(11) DEFAULT NULL,
  `nickname` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `initial_level` int(11) NOT NULL,
...
INSERT INTO `learning` VALUES (35,4,1,'2019-11-26 22:49:13','a:1:{i:0;s:6:\"100.00\";}',1),(35,5,0,'2019-11-26 22:57:53','a:1:{i:0;s:5:\"71.43\";}',0),(35,48,1,'2019-11-20 23:48:22','a:1:{i:0;s:6:\"100.00\";}',1);
...
INSERT INTO `lesson` VALUES (4,2,'Vocabulaire 2','Vocabulaire 2',1,NULL),(5,2,'Mpiasa ve ny couz\' ?','Pour savoir comment demander si le mec là est un travailleur ou pas',2,NULL),(6,3,'Vocabulaire 3','Vocabulaire 3',1,NULL),(7,3,'C ki la meuf','Pour savoir demander c\'est qui le chaton là',2,NULL),(8,4,'Vocabulaire 4','t,Vocabulaire 4',1,NULL),(9,4,'C bon le kafé tu c','Pour être un pro du thé sucré kikoo',2,NULL),(10,5,'Vocabulaire 5',',Vocabulaire 5',1,NULL),(11,5,'Le lait sera froid','Le lait était beau mais le temps sera sucré',2,NULL),(12,6,'Vocabulaire 6',',Vocabulaire 6',1,NULL),(13,6,'Malade le zazakely','Parce que le lait chaud n\'est pas bon pour les enfant. Eh !',2,NULL),(14,7,'Vocabulaire 7','Vocabulaire 7',1,NULL),(15,7,'Comparatifs be','Pour comparer le zébu et le livre',2,NULL),(47,18,'Vocabulaire','Vocabulaire',1,NULL),(48,1,'Intro','Intro',1,NULL),(75,1,'New lesson',NULL,2,NULL),(81,19,'New lesson',NULL,2,NULL);
...
INSERT INTO `question` VALUES (252,'2 - 1',75,NULL,0,1);
...
INSERT INTO `question_proposition` VALUES (198,252,'1','',0),(199,252,'2','',1),(200,252,'3aui','',0);
